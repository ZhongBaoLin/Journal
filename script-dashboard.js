...
window.showStudentStats = async (studentId, studentName) => {
  ...
  try {
    ...
    if (subjects.length === 0) {
      modalBody.innerHTML = '<div class="stat-item">Немає предметів/дисциплін для цього студента</div>';
      return;
    }
