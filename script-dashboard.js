...
async function addGroupAndUpdateSelects(groupName, academicYear) {
  ...
  window.editStudent = (id, name, groupId, phone, role, year) => {
    ...
    document.getElementById("studentYear").value = year || getDefaultAcademicYear();
  ...
  function resetStudentForm() {
    ...
    document.getElementById("studentYear").value = getDefaultAcademicYear();
...
window.editSubject = async (id) => {
    ...
    if (snap.exists() && snap.data().teacherId === currentTeacherId) {
        ...
        document.getElementById("subjectYear").value = d.academicYear || getDefaultAcademicYear();
...
function resetSubjectForm() {
    ...
    document.getElementById("subjectYear").value = getDefaultAcademicYear();
...
function populateSelects() {
  ...
  function populateAcademicYearSelects() {
    ['groupYear', 'studentYear', 'subjectYear'].forEach(id => {
    ...
    if (yearFilter) {
      ...
      yearFilter.innerHTML = '<option value="all">Всі роки</option>' + buildAcademicYearOptionsHtml(false);
      if (prevValue) yearFilter.value = prevValue;
    }
  }
